  ...
  return (
    <footer className="border-t border-slate-200 bg-white dark:bg-slate-900 dark:border-slate-800">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid gap-8 text-xs text-slate-500 dark:text-slate-400 md:grid-cols-[2fr,1fr,1fr,1fr]">
        ...
        <div className="mt-6 border-t border-slate-200 dark:border-slate-800 pt-3 text-center text-[11px] text-slate-400 dark:text-slate-500">
          <p>
