  ...
  return (
    <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-100 hover:border-blue-300">
      ...
      <div className="p-6">
        ...
        {/* Stats Row */}
        <div className="mt-4 pt-4 border-t border-gray-100 grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-4">
          <div className="text-center p-2 bg-gray-50 sm:bg-transparent rounded-lg">
      ...
      <div className="px-6 py-4 bg-gray-50 border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="text-center sm:text-left leading-tight">
          ...
          <div className="text-xs text-gray-500 uppercase font-semibold">Consultation Fee</div>
        </div>

        <div className="flex gap-2 w-full sm:w-auto">
          <button
            onClick={handleViewProfile}
            className="flex-1 sm:flex-none px-4 py-2.5 text-xs font-bold text-blue-600 bg-white border-2 border-blue-600 rounded-xl hover:bg-blue-50 transition-all shadow-sm"
          >
            Profile
          </button>
          <button
