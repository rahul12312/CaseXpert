        ...
        return (
            <div className="w-full h-[400px] bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl flex items-center justify-center border-2 border-blue-200">
                <div className="text-center p-8">
                    ...
                    {lawyer.country && (
                        <p className="text-gray-500 text-sm mb-4">{lawyer.country}</p>
                    )}
                    <button
    ...
    return (
        <div className="w-full">
            <LoadScript googleMapsApiKey={apiKey}>
                ...
                >
                    ...
                    {showInfo && (
                        ...
                        >
                            <div className="p-2">
                                <h4 className="font-bold text-gray-900 mb-1">{lawyer.name}</h4>
                                {lawyer.address_line1 && (
            ...
            {showRoute && (
                <button
                    onClick={openInGoogleMaps}
                    className="mt-4 w-full inline-flex items-center justify-center gap-2 px-6 py-3 bg-white border-2 border-blue-600 text-blue-600 font-bold rounded-xl hover:bg-blue-50 transition-all"
                >
                    <Navigation className="w-5 h-5" />
                    Get Directions
                </button>
