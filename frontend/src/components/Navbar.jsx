                                    ...
                                    <>
                                        ...
                                        <div className="absolute right-0 mt-2 w-56 origin-top-right rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-lg dark:border-slate-700 dark:bg-slate-800 z-20">
                                            ...
                                            <div className="py-1">
                                                ...
                                                {!isAdminUser && (
                                                    <Link
                                                        to={isLawyerUser ? "/lawyer/settings" : "/profile"}
                                                        className={getDropdownLinkClass(isLawyerUser ? location.pathname === '/lawyer/settings' : isProfileActive)}
                                                    >
                                                        <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                                        </svg>
                                                        {isLawyerUser ? "Profile Settings" : "My Profile"}
                                                    </Link>
                                                )}
