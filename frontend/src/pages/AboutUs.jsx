    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <section className="py-16 sm:py-24 bg-white">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
                        ...
                        <div className="relative h-64 overflow-hidden rounded-2xl bg-slate-100 shadow-lg sm:h-96">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center">
                                <div className="text-center p-6">
                                    ...
                                    <div className="text-slate-600 font-medium">Cases Managed</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                        {[
                            ...
                            <div key={value.title} className="rounded-2xl bg-white p-8 shadow-sm transition-all hover:shadow-md">
            ...
            <section className="bg-white py-16 text-center">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <h2 className="text-3xl font-bold text-slate-900">Ready to join the future of law?</h2>
                    <div className="mt-8 flex justify-center gap-4">
                        ...
                        <Link to="/contact" className="rounded-full border border-slate-300 bg-white px-6 py-3 font-semibold text-slate-700 hover:bg-slate-50 transition-colors">
                            Contact Us
                        </Link>
                    </div>
                </div>
