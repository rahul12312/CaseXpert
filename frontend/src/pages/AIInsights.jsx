    ...
    if (loading) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh]">
                ...
                <h3 className="text-xl font-bold text-slate-900 mt-6">Analyzing Legal Data...</h3>
                <p className="text-slate-500 mt-2">AI is detecting patterns and risks in your profile.</p>
            </div>
        );
    }
        ...
        <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-extrabold text-slate-900 tracking-tight">AI Legal Insights</h1>
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        disabled={refreshing}
                        className="group flex items-center gap-2 px-5 py-2.5 bg-white border border-slate-200 text-slate-700 font-bold rounded-xl shadow-sm hover:shadow-md transition-all active:scale-95 disabled:opacity-50"
                    >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
                <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="text-slate-900 font-bold">Past 30 Days</div>
                    </div>
                </div>
                <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="text-slate-900 font-bold">94% Accurate</div>
                    </div>
                </div>
                <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="text-slate-900 font-bold capitalize">{user?.user_type || user?.role || 'User'}</div>
                    </div>
                </div>
                <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <div className="text-slate-900 font-bold">Real-time</div>
                    </div>
                </div>
            </div>
            ...
            {insights.length === 0 ? (
                <div className="bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl p-20 text-center">
                    ...
                    <h3 className="text-xl font-bold text-slate-600 underline decoration-blue-200 decoration-4">Zero Insight Artifacts Found</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {insights.map((insight, index) => (
                        <div
                            key={index}
                            className="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm hover:shadow-xl hover:translate-y-[-4px] transition-all duration-300 group relative overflow-hidden"
                        >
                            {/* Category Accent */}
                                    ...
                                    {insight.action && (
                                        <div className="mt-4 pt-4 border-t border-slate-50 flex items-center gap-3">
                                            ...
                                            <p className="text-sm font-semibold text-indigo-600">
                                                Action: <span className="font-medium text-slate-600">{insight.action}</span>
                                            </p>
                                        </div>
                                    )}
                                </div>
            ...
            {/* Disclaimer Footer */}
            <div className="mt-16 p-6 bg-slate-100/50 rounded-3xl border border-slate-200 text-center">
                <p className="text-xs text-slate-400 max-w-2xl mx-auto font-medium leading-relaxed">
                    <span className="text-slate-600 font-bold uppercase tracking-widest block mb-1">Disclaimer</span>
