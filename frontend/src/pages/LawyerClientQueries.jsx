...
const LawyerClientQueries = () => {
    ...
    const getStatusBadge = (status) => {
        ...
        return badges[status] || 'bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200';
    };
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 p-6 pt-28">
            <div className="mx-auto max-w-7xl">
                ...
                {/* Header */}
                <div className="mb-10">
                    <h1 className="text-4xl font-black text-slate-800 dark:text-white tracking-tight">Client Queries</h1>
                    ...
                    {['all', 'assigned', 'in_progress', 'on_hold', 'resolved'].map(status => (
                        <button
                            ...
                            className={`rounded-md px-4 py-2 text-sm font-medium transition-colors ${filter === status
                                    ...
                                    : 'bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:bg-slate-800'
                                }`}
                        >
                                ...
                                <div className="flex items-start justify-between">
                                    ...
                                    <div className="ml-4 flex flex-col gap-2">
                                        ...
                                        <a
                                            ...
                                            className="rounded-md bg-slate-100 dark:bg-slate-800 px-4 py-2 text-center text-sm font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-200"
                                        >
                                            Contact Client
                                        </a>
                                    </div>
