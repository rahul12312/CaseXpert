  ...
  return (
    <div className="flex flex-1 flex-col gap-4">
      <header className="space-y-2">
        <h1 className="text-xl font-semibold text-slate-900 dark:text-white">AI Legal Assistant</h1>
        <p className="text-xs text-slate-500 dark:text-slate-400">
          Ask high-level legal questions in plain language. Responses are for information only and
          are not a substitute for legal advice.
        </p>
      </header>
      <div className="flex flex-1 flex-col gap-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
            ...
            <select
              ...
              className="h-8 rounded-md border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 px-2 text-xs text-slate-800 dark:text-slate-200 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500"
            >
              {languages.map(l => (
        ...
        <div className="flex-1 space-y-3 overflow-y-auto rounded-lg bg-slate-50 dark:bg-slate-950 p-3">
          {messages.length === 0 && (
        ...
        <form onSubmit={askAssistant} className="mt-2 flex items-end gap-2">
          <textarea
            ...
            className="flex-1 resize-none rounded-md border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-950 px-3 py-2 text-sm text-slate-800 dark:text-slate-200 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500"
          />
          <button
            type="submit"
