      ...
      <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 font-sans">
        <div className="max-w-2xl w-full bg-slate-900/50 backdrop-blur-sm p-6 md:p-8 rounded-[2rem] border border-white/10 shadow-2xl">
          ...
          <div className="relative aspect-video bg-black rounded-2xl overflow-hidden mb-6 border border-slate-700 shadow-inner group">
            ...
            {isVideoOff && <div className="absolute inset-0 flex items-center justify-center text-slate-500 dark:text-slate-400 flex-col gap-2"><VideoOff className="w-12 h-12" /><span>Camera is Off</span></div>}
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-center text-xs text-slate-500 dark:text-slate-400 mt-2 flex items-center justify-center gap-1"><Shield className="w-3 h-3" /> End-to-end encrypted session</p>
          </div>
        </div>
      </div>
    );
      ...
      <main className="flex-1 relative flex flex-col md:flex-row gap-4 p-4 md:p-6 min-h-0">
        ...
        <div className="flex-1 flex flex-col md:flex-row gap-4 relative h-full">
          ...
          <div className="flex-1 bg-slate-900 rounded-[2rem] overflow-hidden border border-white/5 relative group">
            {!isRemoteConnected && <div className="absolute inset-0 flex items-center justify-center text-slate-600 dark:text-slate-400"><div className="text-center"><div className="w-20 h-20 bg-slate-800 rounded-full mx-auto mb-2 animate-pulse" /><p>Remote Feed</p></div></div>}
          ...
          <div className="absolute bottom-4 right-4 w-32 md:w-64 aspect-video bg-slate-800 rounded-xl overflow-hidden border border-white/10 shadow-2xl z-30">
            <video ref={localVideoRef} autoPlay playsInline muted className={`w-full h-full object-cover mirror ${isVideoOff ? 'opacity-0' : 'opacity-100'}`} />
            {isVideoOff && <div className="absolute inset-0 flex items-center justify-center bg-slate-800"><VideoOff className="w-6 h-6 text-slate-500 dark:text-slate-400" /></div>}
          </div>
        </div>
        ...
        {showChat && (
          <div className="absolute right-4 top-4 bottom-4 w-80 bg-slate-900/95 backdrop-blur rounded-2xl border border-white/10 z-50 p-4">
            ...
            <div className="h-full flex items-center justify-center text-slate-500 dark:text-slate-400 text-sm">Chat Module Coming Soon</div>
          </div>
        )}
      </main>
