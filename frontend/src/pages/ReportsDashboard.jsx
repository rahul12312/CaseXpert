...
const ReportsDashboard = () => {
  ...
  if (user.role === 'user') {
    return (
      <div className="flex flex-1 flex-col items-center justify-center text-center p-8 bg-slate-50 dark:bg-slate-950 m-4 rounded-3xl border border-dotted border-slate-300">
  ...
  return (
    <div className="flex flex-1 flex-col gap-4">
      <header className="space-y-2">
        <h1 className="text-xl font-semibold text-slate-900 dark:text-white">Advanced reports</h1>
      ...
      {loading && (
        <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 text-xs text-slate-500 dark:text-slate-400 shadow-sm">
          Loading report data…
        </div>
      )}
      ...
      {overview && (
        <section className="grid gap-3 md:grid-cols-3 lg:grid-cols-4">
          <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
            <p className="text-[11px] font-medium uppercase tracking-wide text-slate-500 dark:text-slate-400">Total cases</p>
            <p className="mt-1 text-2xl font-semibold text-slate-900 dark:text-white">{overview.total_cases}</p>
          </div>
          <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
            <p className="text-[11px] font-medium uppercase tracking-wide text-slate-500 dark:text-slate-400">Active</p>
            <p className="mt-1 text-2xl font-semibold text-emerald-700">{overview.active_cases}</p>
            <p className="mt-1 text-[11px] text-slate-500 dark:text-slate-400">Pending & in-progress matters</p>
          </div>
          <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
            <p className="text-[11px] font-medium uppercase tracking-wide text-slate-500 dark:text-slate-400">Closed</p>
            <p className="mt-1 text-2xl font-semibold text-slate-900 dark:text-white">{overview.closed_cases}</p>
          </div>
          <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
            <p className="text-[11px] font-medium uppercase tracking-wide text-slate-500 dark:text-slate-400">New this month</p>
            <p className="mt-1 text-2xl font-semibold text-slate-900 dark:text-white">{overview.new_cases_this_month}</p>
          </div>
        </section>
      )}
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <div className="space-y-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
          <h2 className="text-sm font-semibold text-slate-800 dark:text-slate-200">Cases by status</h2>
          <p className="text-[11px] text-slate-500 dark:text-slate-400">Snapshot of caseload grouped by current status.</p>
        ...
        <div className="space-y-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
          <h2 className="text-sm font-semibold text-slate-800 dark:text-slate-200">Cases opened over time</h2>
          <p className="text-[11px] text-slate-500 dark:text-slate-400">Based on case creation date for recent matters.</p>
          <div className="mt-2 h-60">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <section className="grid gap-4 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
        <div className="space-y-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
          <div className="flex items-center justify-between gap-2">
            <div>
              <h2 className="text-sm font-semibold text-slate-800 dark:text-slate-200">Case reports</h2>
          ...
          <form
            ...
            className="grid gap-2 rounded-lg bg-slate-50 dark:bg-slate-950 p-3 text-[11px] text-slate-600 dark:text-slate-400 md:grid-cols-3"
          >
            <div className="space-y-1">
              ...
              <input
                ...
                className="h-8 w-full rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-2 text-xs focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500"
              />
            </div>
            <div className="space-y-1">
              <label className="block text-[10px] font-medium uppercase tracking-wide text-slate-500 dark:text-slate-400">
            ...
            <div className="flex items-end gap-2 md:col-span-3 md:justify-end">
              <button
                ...
                className="inline-flex items-center rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-1.5 text-[11px] font-semibold text-slate-700 dark:text-slate-300 shadow-sm hover:bg-slate-50 dark:bg-slate-950"
              >
                Clear
              </button>
              <button
          ...
          <div className="max-h-80 overflow-auto rounded-lg border border-slate-100 dark:border-slate-800">
            <table className="min-w-full border-separate border-spacing-0 text-left text-[11px]">
              <thead className="bg-slate-50 dark:bg-slate-950 text-slate-500 dark:text-slate-400">
                <tr>
                  <th className="sticky top-0 border-b border-slate-200 dark:border-slate-700 px-3 py-2 font-medium">Case</th>
                  <th className="sticky top-0 border-b border-slate-200 dark:border-slate-700 px-3 py-2 font-medium">Status</th>
                  <th className="sticky top-0 border-b border-slate-200 dark:border-slate-700 px-3 py-2 font-medium">Priority</th>
                  <th className="sticky top-0 border-b border-slate-200 dark:border-slate-700 px-3 py-2 font-medium">Created</th>
                  <th className="sticky top-0 border-b border-slate-200 dark:border-slate-700 px-3 py-2 font-medium">Updates</th>
                  <th className="sticky top-0 border-b border-slate-200 dark:border-slate-700 px-3 py-2 font-medium">Documents</th>
                  <th className="sticky top-0 border-b border-slate-200 dark:border-slate-700 px-3 py-2 font-medium">Actions</th>
                </tr>
              </thead>
                ...
                {activeTableRows.length === 0 ? (
                  ...
                  activeTableRows.map(row => (
                    <tr key={row.id} className="hover:bg-slate-50 dark:bg-slate-950">
                      ...
                      <td className="px-3 py-2 align-top">
                        <span className="inline-flex rounded-full bg-slate-100 dark:bg-slate-800 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-slate-700 dark:text-slate-300">
                          {row.status}
                        </span>
                      </td>
                      <td className="px-3 py-2 align-top text-[11px] capitalize text-slate-700 dark:text-slate-300">{row.priority}</td>
                      <td className="px-3 py-2 align-top text-[11px] text-slate-500 dark:text-slate-400">
                        {row.created_at && new Date(row.created_at).toLocaleDateString()}
                      </td>
                      <td className="px-3 py-2 align-top text-[11px] text-slate-700 dark:text-slate-300">
                      ...
                      <td className="px-3 py-2 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <button
                            ...
                            className="inline-flex items-center rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-2 py-1 text-[10px] font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:bg-slate-950"
                          >
                            Download PDF
                          </button>
                          <Link
        ...
        <div className="space-y-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
          <h2 className="text-sm font-semibold text-slate-800 dark:text-slate-200">Case detailed report</h2>
          {!selectedCaseId && (
            <p className="text-xs text-slate-500 dark:text-slate-400">
          ...
          {selectedCaseId && loadingCaseDetails && (
            <p className="text-xs text-slate-500 dark:text-slate-400">Loading case details…</p>
          )}
          {selectedCaseId && !loadingCaseDetails && selectedCaseDetails && (
            <div className="space-y-3 text-xs text-slate-700 dark:text-slate-300">
              <div>
                <p className="text-[11px] font-semibold text-slate-600 dark:text-slate-400">Overview</p>
              ...
              <div className="grid gap-3 md:grid-cols-2">
                <div className="space-y-1">
                  ...
                  <div className="max-h-40 space-y-1 overflow-auto rounded-md bg-slate-50 dark:bg-slate-950 p-2">
                    {selectedCaseDetails.timeline.length === 0 ? (
                      ...
                      selectedCaseDetails.timeline.map(t => (
                        <div key={t.id} className="text-[11px] text-slate-700 dark:text-slate-300">
                          <span className="font-medium">
                            {t.event_date && new Date(t.event_date).toLocaleDateString()} · {t.event_title}
                          </span>
                          {t.event_description && (
                            <span className="text-slate-500 dark:text-slate-400"> — {t.event_description}</span>
                          )}
                        </div>
                      ))
                    )}
                  ...
                  <div className="max-h-40 space-y-1 overflow-auto rounded-md bg-slate-50 dark:bg-slate-950 p-2">
                    {selectedCaseDetails.documents.length === 0 ? (
                      ...
                      selectedCaseDetails.documents.map(d => (
                        <div key={d.id} className="text-[11px] text-slate-700 dark:text-slate-300">
              ...
              <div className="space-y-1">
                ...
                <div className="max-h-32 space-y-1 overflow-auto rounded-md bg-slate-50 dark:bg-slate-950 p-2">
                  {selectedCaseDetails.activities.length === 0 ? (
                    ...
                    selectedCaseDetails.activities.map(a => (
                      <div key={a.id} className="text-[11px] text-slate-700 dark:text-slate-300">
                        ...
                        <div className="text-slate-700 dark:text-slate-300">{a.activity}</div>
                      </div>
                    ))
                  )}
                </div>
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="inline-flex items-center rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-3 py-1.5 text-[11px] font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:bg-slate-950"
                >
                  Close
                </button>
              </div>
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        {isAdmin && (
          <div className="space-y-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
            <h2 className="text-sm font-semibold text-slate-800 dark:text-slate-200">Lawyer performance</h2>
            <p className="text-[11px] text-slate-500 dark:text-slate-400">
              Ranked by success rate, caseload, and rating. Useful for network quality monitoring.
            </p>
            <div className="max-h-72 space-y-1 overflow-auto rounded-md bg-slate-50 dark:bg-slate-950 p-2 text-[11px] text-slate-700 dark:text-slate-300">
              {lawyerPerformance.length === 0 ? (
                ...
                lawyerPerformance.map(l => (
                  <div
                    key={l.lawyer_id}
                    className="flex items-center justify-between rounded-md bg-white dark:bg-slate-900 px-2 py-1 shadow-sm"
                  >
                    <div>
                      <p className="font-medium">{l.lawyer_name}</p>
                      <p className="text-[10px] text-slate-500 dark:text-slate-400">{l.specialization}</p>
                    </div>
        ...
        <div className="space-y-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
          <h2 className="text-sm font-semibold text-slate-800 dark:text-slate-200">My activity (last 30 days)</h2>
          <p className="text-[11px] text-slate-500 dark:text-slate-400">
          ...
          <div className="max-h-72 space-y-1 overflow-auto rounded-md bg-slate-50 dark:bg-slate-950 p-2 text-[11px] text-slate-700 dark:text-slate-300">
            {userActivity.length === 0 ? (
              ...
              userActivity.map((a, idx) => (
                // eslint-disable-next-line react/no-array-index-key
                <div key={idx} className="flex items-start gap-2 border-b border-slate-100 dark:border-slate-800 pb-2 last:border-0">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-600 dark:text-slate-400">{a.description}</p>
