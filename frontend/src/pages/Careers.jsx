            ...
            <div className="w-full">
                ...
                <div className="flex flex-col lg:flex-row bg-white">
                    <div className="lg:w-1/2 p-12 lg:p-24 flex flex-col justify-center">
                        ...
                        <h2 className="text-3xl font-bold text-slate-900 mb-6">Redefining Legal Tech</h2>
                ...
                {/* Block 2 */}
                <div className="flex flex-col lg:flex-row-reverse bg-slate-50">
                    <div className="lg:w-1/2 p-12 lg:p-24 flex flex-col justify-center">
                        <div className="inline-flex items-center gap-2 text-indigo-600 font-semibold mb-4">
                            <Users className="h-5 w-5" />
                            <span>Collaboration & Growth</span>
                        </div>
                        <h2 className="text-3xl font-bold text-slate-900 mb-6">A Culture of Excellence</h2>
                        <p className="text-lg text-slate-600 leading-relaxed mb-8">
                ...
                <div className="flex flex-col lg:flex-row bg-white">
                    <div className="lg:w-1/2 p-12 lg:p-24 flex flex-col justify-center">
                        ...
                        <h2 className="text-3xl font-bold text-slate-900 mb-6">Work That Matters</h2>
                        <p className="text-lg text-slate-600 leading-relaxed mb-8">
