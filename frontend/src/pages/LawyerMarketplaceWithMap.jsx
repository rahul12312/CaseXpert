        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-12">
            ...
            <div className="max-w-7xl mx-auto px-4 -mt-6">
                ...
                <div className="mb-4 text-gray-600 dark:text-gray-400">
                    Showing <span className="font-bold text-gray-900 dark:text-white">{filteredLawyers.length}</span> lawyer{filteredLawyers.length !== 1 ? 's' : ''}
                ...
                {loading ? (
                    ...
                    <div className="text-center py-20 bg-white dark:bg-slate-900 rounded-xl">
                        ...
                        <h3 className="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">No lawyers found</h3>
