                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-8">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600">support@casexpert.com</p>
                                        <p className="text-slate-600">sales@casexpert.com</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4">
                                    <div className="rounded-lg bg-blue-100 p-3 text-blue-600">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600">123 Legal Tech Park,</p>
                                        <p className="text-slate-600">Cyber City, Gurugram, India 122002</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="rounded-2xl bg-gradient-to-br from-indigo-600 to-blue-700 p-8 text-white shadow-lg">
                            ...
                            <a href="/assistant" className="inline-block rounded-lg bg-white px-4 py-2 text-sm font-semibold text-indigo-600 hover:bg-indigo-50 transition-colors">
                                Try AI Assistant
                            </a>
                        </div>
                    </div>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        id="name"
                                        required
                                        className="mt-1 block w-full rounded-md border-slate-300 bg-slate-50 px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm border"
