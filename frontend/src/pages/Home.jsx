  ...
  return (
    <div className={`flex flex-col-reverse ${isEven ? 'md:flex-row' : 'md:flex-row-reverse'} items-center gap-12 md:gap-24 py-8`}>
      ...
      <div className="flex-1 w-full space-y-8">
        <FadeIn>
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-sm font-bold uppercase tracking-widest text-slate-500">{feature.tagline}</span>
          </div>
          ...
          <div className="mt-8 border-t border-slate-200 pt-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                <h4 className="flex items-center gap-2 font-semibold text-slate-900 text-sm uppercase tracking-wide border-b border-slate-100 pb-2">
                  <div className={`w-1.5 h-1.5 rounded-sm bg-slate-400`}></div>
                  Core Competencies
                </h4>
                <ul className="space-y-3">
                  {feature.useCases.map((useCase, i) => (
                    <li key={i} className="flex items-start gap-3 text-sm text-slate-700 leading-relaxed group">
                      <div className={`mt-1.5 w-1 h-1 rounded-full bg-slate-300 group-hover:bg-slate-500 transition-colors`}></div>
                      <span>{useCase}</span>
                    </li>
                  ))}
                </ul>
      ...
      <div className="flex-1 w-full">
        <FadeIn delay={200}>
          <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-2xl group transform hover:-translate-y-2 transition-transform duration-500 border border-slate-100 dark:border-slate-800">
            <img
              src={feature.image}
              alt={feature.title}
