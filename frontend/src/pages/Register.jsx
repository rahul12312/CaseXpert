    ...
    <div className="flex flex-1 items-center justify-center bg-slate-50 dark:bg-slate-950 px-4 py-10 dark:bg-slate-950">
      <div className="w-full max-w-3xl rounded-3xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 shadow-lg dark:border-slate-800 dark:bg-slate-900 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* ========== ADDITIONAL DETAILS ========== */}
          <div className="space-y-4 rounded-xl border-2 border-slate-700 bg-slate-800/50 p-5">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  required
                  disabled={!form.state}
                  className="w-full rounded-lg border border-slate-600 bg-slate-900 px-4 py-2.5 text-sm text-white focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500 disabled:cursor-not-allowed disabled:bg-slate-800 disabled:text-slate-500"
                >
                  <option value="">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <div className="min-h-[42px] rounded-lg border border-slate-600 bg-slate-900 px-3 py-2 flex flex-wrap gap-2 cursor-pointer"
                ...
                {showLanguageDropdown && (
                  <div className="max-h-48 overflow-y-auto rounded-lg border border-slate-600 bg-slate-900 shadow-lg">
          ...
          {isLawyer && (
            <div className="space-y-4 rounded-xl border-2 border-blue-800 bg-blue-900/20 p-5">
              <h3 className="text-base font-semibold text-white flex items-center gap-2">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                {/* Bar ID Number */}
                <div className="space-y-2 md:col-span-2">
                  <label htmlFor="barIdNumber" className="block text-sm font-medium text-slate-300">
