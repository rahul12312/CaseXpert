                ...
                <div className="relative h-32 bg-gradient-to-r from-primary-500 to-primary-600">
                    <div className="absolute -bottom-12 left-8 group">
                        <div className="relative">
                            <div className={`flex h-24 w-24 items-center justify-center rounded-full border-4 border-white bg-slate-100 text-slate-400 shadow-sm overflow-hidden dark:border-slate-900 dark:bg-slate-800 ${isEditing ? 'cursor-pointer' : ''}`}
                            ...
                            {!isEditing ? (
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className="inline-flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700 transition-colors"
                                        disabled={isSaving}
                                    >
                                        <X size={16} />
                                        Cancel
                    ...
                    <div className="mt-8 grid gap-6 sm:grid-cols-2">
                        ...
                        <div className="space-y-1">
                            ...
                            {isEditing ? (
                                ...
                                <div className="flex items-center gap-2 text-slate-900 dark:text-slate-50 font-medium">
            ...
            <div className="grid gap-6 md:grid-cols-2">
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    ...
                    <div className="space-y-3">
                        <button
                            onClick={() => showNotification('error', 'Password change feature coming soon!')}
                            className="flex w-full items-center justify-between rounded-lg border border-slate-200 p-3 text-sm font-medium text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800 transition-colors"
                        >
                ...
                <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                            <span className="text-sm text-slate-700 dark:text-slate-300">Two-Factor Auth</span>
