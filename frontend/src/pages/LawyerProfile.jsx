                    ...
                    <div className="lg:col-span-1">
                        <div className="bg-white rounded-xl shadow-lg overflow-hidden sticky top-4">
                            ...
                            <div className="p-6 text-center border-b border-gray-200">
                                ...
                                <h1 className="text-2xl font-bold text-gray-900 mb-2 break-words">{lawyer.name}</h1>
                            ...
                            <div className="p-6 bg-blue-50 border-b border-gray-200">
                                ...
                                <div className="flex flex-col gap-2">
                                    <button
                                        ...
                                        className="w-full px-6 py-3 bg-blue-100 text-blue-700 font-bold rounded-lg hover:bg-blue-200 transition-all flex items-center justify-center gap-2 border border-blue-200"
                                    >
                                    ...
                                    <div className="space-y-6">
                                                ...
                                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                                    {lawyer.practice_areas.map((area, index) => (
                                                        ...
                                                        >
                                                            ...
                                                            <div>
                                                                <div className="font-semibold text-gray-900 break-words">{area.area_name}</div>
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {lawyer.languages.map((lang, index) => (
                                                        <span
                                                            key={index}
                                                            className="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg font-medium break-words text-center"
                                                        >
                                                            {lang.language_name}
                                            ...
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {(typeof lawyer.courts === 'string' ? JSON.parse(lawyer.courts) : lawyer.courts).map((court, index) => (
                                                        <span
                                                            key={index}
                                                            className="px-4 py-2 border border-gray-200 text-gray-700 rounded-lg font-medium bg-white text-center break-words"
                                                        >
                                                            {court}
                                                        </span>
                                                    ))}
                                        ...
                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                            {lawyer.enrollment_year && (
                                                <div className="p-4 bg-gray-50 rounded-lg">
                                                    <div className="text-sm text-gray-600 mb-1">Enrollment Year</div>
                                                    <div className="text-lg font-bold text-gray-900">{lawyer.enrollment_year}</div>
                                                </div>
                                            )}
                                            {lawyer.bar_council_state && (
                                                <div className="p-4 bg-gray-50 rounded-lg">
                                                    <div className="text-sm text-gray-600 mb-1">Bar Council State</div>
                                                    <div className="text-lg font-bold text-gray-900">{lawyer.bar_council_state}</div>
                                                </div>
                                            )}
                                            {lawyer.response_time && (
                                                <div className="p-4 bg-gray-50 rounded-lg">
                                                    <div className="text-sm text-gray-600 mb-1">Response Time</div>
                                                    <div className="text-lg font-bold text-gray-900">{lawyer.response_time}</div>
                                                </div>
                                            )}
                                            {lawyer.gender && (
                                                <div className="p-4 bg-gray-50 rounded-lg">
                                                    <div className="text-sm text-gray-600 mb-1">Gender</div>
                                                    <div className="text-lg font-bold text-gray-900">{lawyer.gender}</div>
                                                </div>
                                            )}
                                        </div>
                                        ...
                                        <div className="flex flex-wrap gap-3">
                                            ...
                                            {lawyer.is_24_7_support && (
                                                <span className="inline-flex items-center gap-2 px-4 py-2 bg-purple-50 text-purple-700 rounded-lg font-medium">
                                            ...
                                            <div className="flex flex-wrap gap-3">
                                                {lawyer.phone && (
                                                    <a
                                                        ...
                                                        className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-blue-300 text-blue-700 rounded-lg hover:bg-blue-50 transition-colors font-medium"
                                                    >
                                                ...
                                                {lawyer.availability.map((schedule, index) => (
                                                    ...
                                                    >
                                                        <div className="flex items-center justify-between">
                                                            <div className="font-semibold text-gray-900">{schedule.day_of_week}</div>
