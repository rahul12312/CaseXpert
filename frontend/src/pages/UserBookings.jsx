...
const UserBookings = () => {
    ...
    return (
        <div className="max-w-5xl mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold text-gray-900 mb-8">My Consultations</h1>

            {bookings.length === 0 ? (
                <div className="text-center py-12 bg-gray-50 rounded-2xl border border-gray-100">
                    <Calendar className="w-16 h-16 text-gray-300 mx-auto mb-4" />
                    <h3 className="text-xl font-medium text-gray-900 mb-2">No bookings found</h3>
                    <p className="text-gray-500 mb-6">You haven't booked any consultations yet.</p>
                        ...
                        <div key={booking.id} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 flex flex-col md:flex-row gap-6 hover:shadow-md transition-shadow">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex items-center gap-4 mt-2 mb-4">
                                    ...
                                    />
                                    <div>
                                        <div className="font-semibold text-gray-900">{booking.lawyer_name}</div>
                                        <div className="text-sm text-gray-500">{booking.specialization} Lawyer</div>
                                    </div>
                                </div>
                            ...
                            <div className="flex flex-col justify-center items-end gap-3 min-w-[140px]">
                                ...
                                <Link
                                    ...
                                    className="w-full text-center px-4 py-2 border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 text-sm font-medium transition"
                                >
                                    View Profile
                                </Link>
                            </div>
