    ...
    const showNotification = (booking) => {
        toast.custom((t) => (
            <div
                ...
                } max-w-md w-full bg-white dark:bg-slate-900 shadow-2xl rounded-2xl pointer-events-auto flex ring-1 ring-black ring-opacity-5 overflow-hidden`}
            >
                ...
                <div className="flex border-l border-gray-200 dark:border-gray-700">
                    ...
                    <button
                        ...
                        className="w-full border border-transparent rounded-none p-4 flex items-center justify-center text-sm font-medium text-gray-400 hover:text-gray-500 dark:text-gray-400 focus:outline-none"
                    >
                        Close
                    </button>
                </div>
