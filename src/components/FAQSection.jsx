...
const FAQItem = ({ question, answer, isOpen, onClick }) => {
    return (
        <div className={`border-b border-slate-200 dark:border-slate-700 last:border-0 transition-all duration-300 ${isOpen ? 'bg-blue-50/30' : ''}`}>
            <button
                onClick={onClick}
    ...
    return (
        <section className="py-12 px-4 sm:px-0">
            <div className="mx-auto max-w-4xl">
                ...
                {/* Accordion List */}
                <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-6 shadow-sm sm:px-8">
