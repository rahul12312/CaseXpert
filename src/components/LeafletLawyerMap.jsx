...
const LeafletLawyerMap = ({ lawyer, showRoute = true }) => {
    ...
    if (!lawyer || !hasValidCoordinates) {
        return (
            <div className="w-full h-[300px] sm:h-[400px] bg-gray-50 dark:bg-gray-900 rounded-xl flex items-center justify-center border-2 border-dashed border-gray-300">
    ...
    return (
        <div className="w-full flex flex-col gap-4">
                            ...
                            <Popup className="custom-popup">
                                <div className="p-1 min-w-[200px] max-w-[250px]">
                                    ...
                                    {lawyer.address_line1 && (
                                        <p className="text-xs text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-900 p-2 rounded mb-2 line-clamp-3 break-words leading-relaxed">
                                            {lawyer.address_line1}
                                        </p>
                                    )}
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-white dark:bg-slate-900 p-1 rounded-lg">
                {/* Left: Status */}
