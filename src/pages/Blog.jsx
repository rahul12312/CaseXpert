        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 py-12 px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-7xl">
                <div className="text-center mb-12">
                    <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white sm:text-4xl">CaseXpert Blog</h1>
                    <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">Insights, updates, and guides from the world of law and technology.</p>
                </div>

                <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    {posts.map(post => (
                        <div key={post.id} className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm hover:shadow-md transition-shadow p-6 flex flex-col items-start border border-slate-100 dark:border-slate-800">
                            <div className="mb-4">
                            ...
                            <div className="mt-auto flex w-full items-center justify-between text-sm text-slate-500 dark:text-slate-400 border-t pt-4">
                                <span>{post.date}</span>
