  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="bg-white dark:bg-slate-900 rounded-t-2xl shadow-lg p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Powered by GPT-4o-mini</p>
              </div>
            </div>
            <button
              onClick={clearChat}
        ...
        {/* Chat Messages */}
        <div className="bg-white dark:bg-slate-900 shadow-lg" style={{ height: '500px', overflowY: 'auto' }}>
        ...
        {/* Input Area */}
        <div className="bg-white dark:bg-slate-900 rounded-b-2xl shadow-lg p-6 border-t border-gray-200 dark:border-gray-700">
        ...
        {/* Quick Questions */}
        <div className="mt-6 bg-white dark:bg-slate-900 rounded-2xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            {[
              ...
              <button
                ...
                className="text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:bg-gray-800 rounded-lg transition-colors"
                disabled={isLoading}
              >
                {question}
              </button>
