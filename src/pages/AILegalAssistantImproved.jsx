...
const API_URL = `${API_BASE_URL}/ai-legal-assistant/chat`;
...
const MessageContent = ({ content }) => {
  try {
      ...
      return (
        <div className="space-y-3">
          <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-800 pb-2 mb-2">
            <span className="font-bold text-lg text-gray-800 dark:text-gray-200">Case Prediction Analysis</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-green-50 p-3 rounded-lg border border-green-100">
              ...
              <ul className="list-disc ml-4 text-xs space-y-1 text-gray-700 dark:text-gray-300">
      ...
      return (
        <div className="space-y-4">
          <div className="flex items-center justify-between border-b pb-2">
            <span className="font-bold text-lg text-gray-800 dark:text-gray-200">Legal Cost Estimation</span>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 dark:bg-gray-900 p-3 rounded-lg text-center">
              <p className="text-xs text-gray-500 dark:text-gray-400 uppercase font-semibold">Expected Duration</p>
              <p className="text-lg font-bold text-gray-800 dark:text-gray-200">{data.expected_duration}</p>
            </div>
          ...
          <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-gray-700 p-4 rounded-lg shadow-sm">
            <p className="font-semibold text-sm mb-3 text-gray-700 dark:text-gray-300 border-b pb-2">Detailed Breakdown (Estimated)</p>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Lawyer / Professional Fees</span>
                <span className="font-medium">₹{data.cost_breakdown?.lawyer_fees?.toLocaleString() || 0}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Court & Filing Fees</span>
                <span className="font-medium">₹{data.cost_breakdown?.court_fees?.toLocaleString() || 0}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600 dark:text-gray-400">Miscellaneous</span>
    ...
    return (
      <div className="space-y-2 font-mono text-sm bg-gray-50 dark:bg-gray-900 p-3 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        {Object.entries(data).map(([key, value]) => (
          <div key={key} className="border-b border-gray-200 dark:border-gray-700 last:border-0 pb-2 mb-2 last:mb-0 last:pb-0">
            <span className="font-bold capitalize text-xs text-indigo-700 block mb-1">{key.replace(/_/g, ' ')}</span>
            <div className="pl-2 text-gray-800 dark:text-gray-200">
              {Array.isArray(value) ? (
...
const AILegalAssistantImproved = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      {/* Sidebar - Sessions */}
      <div className={`${sidebarOpen ? 'w-64' : 'w-0'} bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 overflow-hidden flex flex-col`}>
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex justify-between items-center mt-1">
                  ...
                  {session.task && session.task !== 'DEFAULT_CHAT' && (
                    <span className="text-[10px] bg-gray-100 dark:bg-gray-800 px-1 rounded text-gray-600 dark:text-gray-400">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="bg-white dark:bg-slate-900 border-b border-gray-200 dark:border-gray-700 shadow-sm z-10 flex flex-col">
          <div className="flex items-center justify-between p-4 pb-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900 dark:text-white leading-tight">AI Legal Associate</h1>
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center justify-center p-2 min-w-[90px] w-[90px] h-[70px] rounded-xl border transition-all cursor-pointer snap-start flex-shrink-0 ${isActive
                    ...
                    : 'bg-white dark:bg-slate-900 border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-900 hover:border-gray-300'
                    }`}
                  title={task.desc}
                >
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-6 bg-gray-50/50">
              ...
              <div
                className={`max-w-[100%] sm:max-w-[80%] rounded-2xl px-5 py-4 shadow-sm text-sm ${message.role === 'user'
                  ...
                  : message.isError
                    ...
                    : 'bg-white dark:bg-slate-900 text-gray-900 dark:text-white border border-gray-100 dark:border-gray-800 rounded-bl-none'
                  }`}
              >
                {message.role === 'assistant' ? (
          ...
          {isLoading && (
            <div className="flex gap-4 justify-start">
              ...
              <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-gray-700 rounded-2xl px-5 py-4 shadow-sm rounded-bl-none">
        ...
        {/* Input Area */}
        <div className="bg-white dark:bg-slate-900 border-t border-gray-200 dark:border-gray-700 p-4">
          <form onSubmit={handleSendMessage} className="max-w-4xl mx-auto relative">
            <div className="relative flex items-end gap-2 bg-gray-50 dark:bg-gray-900 border border-gray-300 rounded-2xl p-2 focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-transparent transition-all shadow-sm">
              <textarea
                value={inputMessage}
                onChange={(e) => setInputMessage(e.target.value)}
                onKeyPress={handleKeyPress}
                placeholder={`Ask ${activeTask.label}... (Shift+Enter for new line)`}
                className="flex-1 bg-transparent border-0 focus:ring-0 resize-none py-3 px-3 max-h-32 text-gray-900 dark:text-white placeholder-gray-500 text-sm"
                rows="1"
