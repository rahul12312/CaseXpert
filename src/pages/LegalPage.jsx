...
const LegalPage = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 py-12 px-4 sm:px-6 lg:px-8">
            <div className="mx-auto max-w-3xl bg-white dark:bg-slate-900 rounded-2xl shadow-sm p-8 sm:p-12">
                <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white mb-2">{data.title}</h1>
                <p className="text-sm text-slate-500 dark:text-slate-400 mb-8">Last Updated: {data.updated}</p>
