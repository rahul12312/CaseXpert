...
const CaseList = () => {
  ...
  const getPriorityColor = (priority) => {
    ...
    return colors[priority] || 'bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400';
  };
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {cases.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">No cases</h3>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Get started by creating a new case.</p>
          <div className="mt-6">
            <Link
              to="/cases/create"
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {cases.map((caseItem) => (
            <Link
              ...
              className="block bg-white dark:bg-slate-900 rounded-lg shadow hover:shadow-lg transition-shadow duration-200 overflow-hidden"
            >
              <div className="p-6">
                ...
                {/* Stats */}
                <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400 pt-4 border-t border-gray-100 dark:border-gray-800">
